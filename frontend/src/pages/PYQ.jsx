        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-extrabold text-sm shadow-md transition-all duration-300 disabled:opacity-50 text-center"
            >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-extrabold px-5 py-2.5 rounded-xl shadow-md transition-all cursor-pointer"
            >
              Upload PYQ
            </button>
          </div>
        ...
        {loading ? (
          ...
          >
            ...
            {!showBookmarks && (
              <button
                onClick={() => setShowUpload(true)}
                className="px-5 py-2.5 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-extrabold shadow-md transition-all cursor-pointer"
              >
                Upload First PYQ
              </button>
            )}
