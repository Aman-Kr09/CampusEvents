    ...
    <div className="min-h-screen flex flex-col justify-between py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 sm:top-6 sm:right-6 z-10 flex items-center space-x-2 sm:space-x-3">
        <a
          ...
          className="flex items-center space-x-1.5 text-xs text-emerald-300 hover:text-white bg-emerald-950/60 hover:bg-emerald-900/80 border border-emerald-500/40 hover:border-emerald-400 px-3 py-2 rounded-xl transition-all duration-200 font-semibold shadow-glow/10"
